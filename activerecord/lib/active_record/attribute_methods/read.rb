    ...
    module Read
      ...
      TextReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            @attributes.fetch_raw_value(name)
          end
          EOMETHOD
        end
      }.new
      ...
      IntegerReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.value_to_integer(v)
          end
          EOMETHOD
        end
      }.new
      ...
      DecimalReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.value_to_decimal(v)
          end
          EOMETHOD
        end
      }.new
      ...
      DatetimeReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.string_to_time(v)
          end
          EOMETHOD
        end
      }.new
      ...
      TimeReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.dummy_time_string(v)
          end
          EOMETHOD
        end
      }.new
      ...
      DateReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.string_to_date(v)
          end
          EOMETHOD
        end
      }.new
      ...
      BinaryReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.binary_to_string(v)
          end
          EOMETHOD
        end
      }.new
      ...
      BooleanReaderMethodCache = Class.new(AttributeMethodCache) {
        def method_body(method_name, const_name)
          ...
          def #{method_name}
            name = ::ActiveRecord::AttributeMethods::AttrNames::ATTR_#{const_name}
            v = @attributes.fetch_raw_value(name)
            v && ActiveRecord::AttributeMethods::Read::TypeConverter.value_to_boolean(v)
          end
          EOMETHOD
        end
      }.new
      ...
      module ClassMethods
        ...
        if Module.methods_transplantable?
          ...
          def rails3_attribute_method_cache(name)
            return ReaderMethodCache if self.column_for_attribute(name).cast_type.is_a?(Type::Serialized)
